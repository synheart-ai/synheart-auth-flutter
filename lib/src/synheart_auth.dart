...
/// SynheartAuth.instance.configure('https://api.synheart.ai/auth');
///
/// // 2. Sign every HTTP request (registration is handled by
/// //    synheart-core-runtime; this Flutter shell only signs).
