...
void main() {
  group('DeviceAuthState', () {
    test('unregistered can transition to challengeReceived', () {
      expect(
        DeviceAuthState.unregistered
            .canTransition(DeviceAuthState.challengeReceived),
        isTrue,
      );
    });
    ...
    test('challengeReceived can transition to keyReady', () {
      expect(
        DeviceAuthState.challengeReceived
            .canTransition(DeviceAuthState.keyReady),
        isTrue,
      );
    });
    ...
    test('transition returns new state', () {
      final next = DeviceAuthState.unregistered
          .transition(DeviceAuthState.challengeReceived);
