...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-auth-flutter/security/advisories/new).
...
This policy covers the `synheart_auth` SDK published from this repository. Issues
