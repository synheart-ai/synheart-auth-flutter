...
Thank you for taking the time to look at Synheart Auth (Flutter). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-auth-flutter/issues) to avoid
   duplicates.
